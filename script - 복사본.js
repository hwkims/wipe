...
export class Ball {
  ...
  render(ctx) {
    ctx.imageSmoothingEnabled = false; // 이미지 스무딩 끄기
...
export class Game
{
    ...
    init()
    {
        ...
        this.wiper = new Wiper(new Vector2(this.width / 2.0, this.height / 2.0), this.height * 0.95, 11, 4);
